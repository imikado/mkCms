<?php
class model_menu extends abstract_model{
	
	protected $sClassRow='row_menu';
	
	protected $sTable='menu';
	...
	public function getSelect(){
		...
		if($tab){
		foreach($tab as $oRow){
			$tSelect[ $oRow->id ]=$oRow->men_title;
		}
		}
		return $tSelect;
	}
...
class row_menu extends abstract_row{
	
	protected $sClassModel='model_menu';
