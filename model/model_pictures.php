<?php
class model_pictures extends abstract_model{
	
	protected $sClassRow='row_pictures';
	
	protected $sTable='pictures';
...
class row_pictures extends abstract_row{
	
	protected $sClassModel='model_pictures';
