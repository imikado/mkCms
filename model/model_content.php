<?php
class model_content extends abstract_model{
	
	protected $sClassRow='row_content';
	
	protected $sTable='content';
	...
	public function findAll(){
		return $this->findMany('SELECT * FROM '.$this->sTable.'  ORDER BY cont_datetime DESC');
	}
	public function findListByCat($uId){
		return $this->findManySimple('SELECT * FROM '.$this->sTable.' WHERE category_id=? ORDER BY cont_datetime DESC',$uId );
	}
	...
	public function getSelect(){
		...
		if($tab){
		foreach($tab as $oRow){
		//	if($oRow->category_id){ continue;}
			$tSelect[ $oRow->id ]=$oRow->cont_title;
		}
		}
		return $tSelect;
	}
...
class row_content extends abstract_row{
	
	protected $sClassModel='model_content';
