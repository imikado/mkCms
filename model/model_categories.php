<?php
class model_categories extends abstract_model{
	
	protected $sClassRow='row_categories';
	...
	public function getSelect(){
		$tab=$this->findAll();
		$tSelect=array('Sans categorie');
		if($tab){
		foreach($tab as $oRow){
			$tSelect[ $oRow->id ]=$oRow->cat_title;
		}
		}
		return $tSelect;
	}
...
class row_categories extends abstract_row{
	
	protected $sClassModel='model_categories';
