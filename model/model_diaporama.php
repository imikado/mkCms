<?php
class model_diaporama extends abstract_model{
	
	protected $sClassRow='row_diaporama';
	
	protected $sTable='diaporama';
...
class row_diaporama extends abstract_row{
	
	protected $sClassModel='model_diaporama';
